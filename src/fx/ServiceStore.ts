...
const logger = appLogger.create("ServiceStore");
    ...
    private emit(newState, oldState) {
        for(let l of this.listeners) {
            try {
                ...
                logger("Ignoring error during ServiceStore change event", err).error();
            }
        }
    }
